...
\textbf{Part C:}
    ...
    \textbf{ii. Suggested Alternative}\newline
	We would suggest the following ingredient list based on wanting to prioritize the caloric content of the meal and just make enough margin on price:
    \begin{verbatim}
    Ingredient   Amount
        LE         0.359265
        SP         0.192344
    ...
    \textbf{iii. Derivation of Solution}\newline
