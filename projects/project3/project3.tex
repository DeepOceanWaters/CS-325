...
END
 ...
 NO. ITERATIONS=       0
    ...
    The min of the max absolute deviations was 0.\newline
    
    \textbf{iii. Graph}\newline
    \includegraphics[width=\textwidth]{p3pbiii}
    The MMAD makes up the same line as the LAD approach, and thus just like our LAD observation it creates a line that adjusts more for outliers, like at x = 2, than the least squares approach. The line goes through y = 0 has a generally steeper slope than the least squares line, and is not shifted by $a_0$ since it equals zero in this case.\newline
